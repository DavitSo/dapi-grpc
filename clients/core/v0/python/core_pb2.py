...
_TRANSACTIONDETAIL = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='timeUtc', full_name='org.dash.platform.dapi.v0.TransactionDetail.timeUtc', index=3,
