...
_GETADDRESSBALANCEREQUEST_ADDRESSES = _descriptor.Descriptor(
  name='Addresses',
  full_name='org.dash.platform.dapi.v0.GetAddressBalanceRequest.Addresses',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='items', full_name='org.dash.platform.dapi.v0.GetAddressBalanceRequest.Addresses.items', index=0,
...
_GETADDRESSBALANCEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='addresses', full_name='org.dash.platform.dapi.v0.GetAddressBalanceRequest.addresses', index=0,
  ...
  nested_types=[_GETADDRESSBALANCEREQUEST_ADDRESSES, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_GETADDRESSBALANCEREQUEST_ADDRESSES.containing_type = _GETADDRESSBALANCEREQUEST
_GETADDRESSBALANCEREQUEST.fields_by_name['addresses'].message_type = _GETADDRESSBALANCEREQUEST_ADDRESSES
...
GetAddressBalanceRequest = _reflection.GeneratedProtocolMessageType('GetAddressBalanceRequest', (_message.Message,), dict(
  ...
  Addresses = _reflection.GeneratedProtocolMessageType('Addresses', (_message.Message,), dict(
    DESCRIPTOR = _GETADDRESSBALANCEREQUEST_ADDRESSES,
    __module__ = 'core_pb2'
    # @@protoc_insertion_point(class_scope:org.dash.platform.dapi.v0.GetAddressBalanceRequest.Addresses)
    ))
  ,
...
_sym_db.RegisterMessage(GetAddressBalanceRequest.Addresses)
