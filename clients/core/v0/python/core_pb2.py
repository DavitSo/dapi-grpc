...
_GETADDRESSBALANCEREQUEST_ADDRESSES = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='addresses', full_name='org.dash.platform.dapi.v0.GetAddressBalanceRequest.Addresses.addresses', index=0,
...
_GETADDRESSBALANCEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='items', full_name='org.dash.platform.dapi.v0.GetAddressBalanceRequest.items', index=0,
...
_GETADDRESSBALANCEREQUEST.fields_by_name['items'].message_type = _GETADDRESSBALANCEREQUEST_ADDRESSES
