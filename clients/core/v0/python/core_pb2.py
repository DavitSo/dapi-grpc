...
_GETADDRESSTRANSACTIONSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='limit', full_name='org.dash.platform.dapi.v0.GetAddressTransactionsRequest.limit', index=1,
      number=2, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='page_number', full_name='org.dash.platform.dapi.v0.GetAddressTransactionsRequest.page_number', index=2,
      number=3, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TRANSACTIONDETAIL_TIME = _descriptor.Descriptor(
  name='Time',
  full_name='org.dash.platform.dapi.v0.TransactionDetail.Time',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='seconds', full_name='org.dash.platform.dapi.v0.TransactionDetail.Time.seconds', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='nanos', full_name='org.dash.platform.dapi.v0.TransactionDetail.Time.nanos', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TRANSACTIONDETAIL = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='time', full_name='org.dash.platform.dapi.v0.TransactionDetail.time', index=3,
  ...
  nested_types=[_TRANSACTIONDETAIL_TIME, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_TRANSACTIONDETAIL_TIME.containing_type = _TRANSACTIONDETAIL
_TRANSACTIONDETAIL.fields_by_name['time'].message_type = _TRANSACTIONDETAIL_TIME
...
TransactionDetail = _reflection.GeneratedProtocolMessageType('TransactionDetail', (_message.Message,), dict(
  ...
  Time = _reflection.GeneratedProtocolMessageType('Time', (_message.Message,), dict(
    DESCRIPTOR = _TRANSACTIONDETAIL_TIME,
    __module__ = 'core_pb2'
    # @@protoc_insertion_point(class_scope:org.dash.platform.dapi.v0.TransactionDetail.Time)
    ))
  ,
...
_sym_db.RegisterMessage(TransactionDetail.Time)
